...
def get_loss(model, testenc,nsamples, bs=1, device=None):
    ...
    for item in tqdm(testenc.select(range(nsamples))):
        ...
        log_likelihood_1 = loglikelihood(model, question, context, final_decision)
...
def sleb(
    ...
    # removal_list=[4, 22, 19, 14, 25, 10, 20]
    ...
    if eval_zeroshot:
        ...
        if '30b' or '66b' or '70b' in model_name:
            ...
            parallelize = False
        # tasks = ['pubmedqa','mathqa','arc_challenge','arc_easy','boolq','piqa','winogrande','hellaswag']
