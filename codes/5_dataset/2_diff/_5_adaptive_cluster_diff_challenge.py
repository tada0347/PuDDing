    ...
    for item in tqdm(dataset.select(range(total))):
        ...
        with open(result_path, mode='a', encoding="utf-8",newline='') as outfile:
            ...
            for i in range(len(text)):
                ...
                new_row = {'inputs': inputs, 'max_idx': max_idx, 'max_set': max_set,'softmax': softmax_values, 'minmax_softmax': softmax_minmax_values,'likelihood_diff': diff_list }                # print(f'row1: {new_row}')
