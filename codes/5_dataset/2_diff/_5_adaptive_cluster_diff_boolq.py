    ...
    for item in tqdm(dataset.select(range(total))):
        ...
        with open(open_path, mode='r', newline='') as infile:
            ...
            for row in reader:
                ...
                if label ==True:
                    log_likelihood = float(loglikelihood(temp_model,passage, question, 'True'))-float(loglikelihood(temp_model,passage, question, 'False'))
                elif label ==False:
                    log_likelihood = float(loglikelihood(temp_model,passage, question, 'False'))-float(loglikelihood(temp_model,passage, question, 'True'))
                else:
