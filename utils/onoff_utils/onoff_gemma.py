...
class OnOff_Gemma2DecoderLayer(nn.Module):
    def __init__(self, original_decoder_layer):
        ...
        self.pre_feedforward_layernorm = original_decoder_layer.pre_feedforward_layernorm
        self.post_feedforward_layernorm = original_decoder_layer.post_feedforward_layernorm
...
def block_replace(model):
    ...
    for i in range(num_layers):
        model.model.layers[i] = OnOff_Gemma2DecoderLayer(model.model.layers[i])
